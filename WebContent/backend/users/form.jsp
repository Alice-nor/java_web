			...
			<div class="row">
				<div class="col-md-12">
					...
					新增使用者
							...
							<input type="text" class="form-control"name="name" placeholder="輸入使用者名稱" value="<c:out value="${one_user.name}"/>"></div>
							<div class="form-group">
								<label>E-mail</label>
								<input type="email" class="form-control"name="email" placeholder="輸入 email"value="<c:out value="${one_user.email}"/>"></div>
